...
OUTPUT
 ...
 Enter the data to be stored : 6

 Inserting the key : 6 in hash table
 Hash value 1 : 4
...
Do you want to enter other data (0/1) : 1
 ...
 Inserting the key : 12 in hash table
 Hash value 1 : 9
...
Do you want to enter other data (0/1) : 1
 ...
 The data is already present in the hash table at location 9
Do you want to enter other data (0/1) : 1

 Enter the data to be stored : 15

 Inserting the key : 15 in hash table
 Hash value 1 : 2
