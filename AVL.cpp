...
class avl_tree {
   public:
      ...
      avl *rr_rotat(avl *);  // right right case
      avl *ll_rotat(avl *);// left left case
...
avl *avl_tree::balance(avl *t) {
   ...
   int bal_factor = difference(t);  // left h - right h
...
OUTPUT
         ...
         You can perform following operations on AVL Tree :-

                 1. Construct AVL
                 2. Insert Element into the tree
         ...
         Enter number of nodes to insert in AVL Tree :- 4
    ...
    19   6    5 Root -> 4   2
         ...
         Enter your Choice: 6
                 ...
                 Postorder Traversal:2 5 19 6 4 
